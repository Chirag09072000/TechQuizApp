...
public class RegisterStudentFrame extends javax.swing.JFrame {
    ...
    **/
    ...
    private void initComponents() {
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/techquizapp/images/examicon.png"))); // NOI18N
        ...
        jButton1.setForeground(new java.awt.Color(255, 39, 1));
    ...
    boolean isValidInput=validateInputs();
        ...
        if(password.equals(confirmPassword))
        {
           try
           {
            ...
            boolean registerStudent=UserDAO.registerStudent(std);
            if(registerStudent)
            {
            ...
            {
             JOptionPane.showMessageDialog(null,"Registration Of Student Unsuccessfull","Registration Denied!",JOptionPane.INFORMATION_MESSAGE);
            }
            txtUsername.setText("");
            txtPassword.setText("");
        ...
        {
            JOptionPane.showMessageDialog(null,"Error while connecting to DB!","Register Student Error!",JOptionPane.ERROR_MESSAGE);
            sq.printStackTrace();
        }
        }
        else
